...
export default function MostLikedPage() {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      // Add likes count and sort by most liked
      const galleriesWithLikes = galleriesData
        .map(g => ({ ...g, likes_count: likesMap.get(g.id) || 0 }))
    ...
    <div className="max-w-7xl mx-auto px-3 md:px-4 py-4 md:py-8">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold">Most Liked Galleries</h1>
        </div>
      </div>
